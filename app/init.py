...
def create_app():
    ...
    mail.init_app(app)
    logger.info("✅ Flask-Mail initialised successfully")
    ...
    logger.info("🚀 Entrepreneur Routes:")
    ...
    logger.info("=" * 80)
    logger.info("✅ All Blueprints Loaded Successfully!")
    logger.info("🎉 SEIC App is Ready to Handle Requests")
    logger.info("=" * 80 + "\n")
